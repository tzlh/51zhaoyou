...
function nav_menu_output(output_id) {
  var content = 
    ...
    '        <a href = "../index/user_list.html" class = "list-group-item clearfix nav_pl30">用户列表</a>'+
    '        <a class = "list-group-item clearfix active nav_radius">首页面数据<span class = "glyphicon glyphicon-chevron-down pull-right"></span></a>'+
    '        <a href = "../index/price_change.html" class = "list-group-item clearfix nav_pl30">价格变动</a>'+
    '        <a href = "../index/dynamic_data.html" class = "list-group-item clearfix nav_pl30">动态数据</a>'+
    ...
    '        <a href = "../index/entrust_data_list.html" class = "list-group-item clearfix nav_pl30">委托需求</a>'+
    '        <a href = "../index/demand_data_list.html" class = "list-group-item clearfix nav_pl30">委托信息</a>'+
