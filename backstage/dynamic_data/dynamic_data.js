...
class PriceChange {
  constructor() {
    ...
    this.priceData = {
      "data":[
        ...
        {"type":"0", "price":"200", "data_time":"2017-05-06 00:00:00", "uuid":"003"}]
    };
  }
  //清空数据
  clearRawData() {
  ...
  serverDataCover() {
    this.priceData = {};
    //获取
    let Url = PROJECT_PATH + "lego/lego_51zy?servletName=getIndexDataDynamicData";
  ...
  addData () {
    ...
    let addUrl = PROJECT_PATH + "lego/lego_51zy?servletName=addIndexDataDynamicData";
  ...
  editData(obj) {
    ...
    let editUrl = PROJECT_PATH + "lego/lego_51zy?servletName=modifyIndexDataDynamicData";
  ...
  deleteData (obj) {
    ...
    let deleteUrl = PROJECT_PATH + "lego/lego_51zy?servletName=removeIndexDataDynamicData";
